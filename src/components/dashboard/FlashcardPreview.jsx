...
const FlashcardPreview = ({ className }) => {
  ...
  return (
    <Card className={cn("overflow-hidden transition-all duration-300 hover:shadow-md border border-border/60", className)}>
      ...
      <CardContent className="pt-4 h-[150px] flex items-center justify-center cursor-pointer" onClick={() => setIsFlipped(!isFlipped)}>
        <div className="w-full h-full perspective-[1000px]">
          <div
            className={cn(
              "relative w-full h-full transform transition-all duration-500",
          ...
          >
            <div 
              className="absolute w-full h-full bg-secondary/50 rounded-md p-4 flex items-center justify-center text-center"
              style={{
            ...
            <div 
              className="absolute w-full h-full bg-primary/10 rounded-md p-4 flex items-center justify-center text-center"
              style={{
                backfaceVisibility: "hidden",
